...
%Basic configuration
\title{PERANCANGAN DESAIN INTERAKSI APLIKASI PENCEGAH DISTRAKSI \textit{DIGITAL WELLEBEING} DENGAN PENDEKATAN \textit{USER-CENTERED DESIGN}}
\date{}
\author{
