...
\setlength{\lofidescwidth}{0.34\textwidth}
...
\RaggedLeft
\begin{footnotesize}
\begin{longtable}[c]{|>{\ccnormspacingcenter}p{0.1\textwidth}|>{\ccnormspacing}p{\lofidescwidth}|>{\ccnormspacingcenter}p{0.11\textwidth}|>{\ccnormspacingcenter}p{\lofiwidth}|}
