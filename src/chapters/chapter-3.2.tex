...
\RaggedLeft
\begin{small}
\begin{longtable}[c]{|W{c}{0.07\textwidth}|>{\ccbnormspacing}m{\cccolgoal}|>{\ccbnormspacing}m{0.4\textwidth}|>{\ccbnormspacingcenter}m{\cccolneed}|}
  ...
  UT-05 & & Menyetel pengaturan notifikasi & \\ \ccline
  UT-06 & \ccgoal{-4}{Mencegah distraksi dari \textit{smartphone} di waktu tertentu} & Memilih aplikasi yang diblokir aksesnya & \ccneed{-4}{PP-07, PP-11, PP-17, KP-01, KP-07}\\ \hline
