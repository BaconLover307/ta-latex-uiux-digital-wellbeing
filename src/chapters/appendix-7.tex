...
\begin{longtable}[c]{|m{0.04\textwidth}|>{\baselineskip=8pt}m{0.45\textwidth}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|>{\baselineskip=8pt}p{\coln}|}
  ...
  2. & Kegiatan ini menyenangkan untuk dilakukan &  &  &  &  &  &  &  \\ \hline
  3. & Saya pikir ini adalah kegiatan yang membosankan &  &  &  &  &  &  &  \\ \hline
  4. & Kegiatan ini tidak menarik perhatian saya &  &  &  &  &  &  &  \\ \hline
  5. & Saya dapat mendeskripsikan kegiatan ini sebagai sangat menarik  &  &  &  &  &  &  &  \\ \hline
  6. & Saya rasa kegiatan ini cukup menyenangkan &  &  &  &  &  &  &  \\ \hline
  7. & Ketika saya melakukan kegiatan ini, saya memikirkan betapa saya menikmatinya &  &  &  &  &  &  &  \\ \hline
  
  \rowcolor[HTML]{DCF3FC} \multicolumn{9}{|l|}{\textbf{\textit{Pressure / Tension}}} \\ \hline
  1. & Saya tidak merasa gugup sama sekali selama melakukan kegiatan ini &  &  &  &  &  &  &  \\ \hline
  2. & Saya merasa sangat tegang selama melakukan kegiatan ini &  &  &  &  &  &  &  \\ \hline
  3. & Saya merasa santai selama melakukan kegiatan ini &  &  &  &  &  &  &  \\ \hline
  4. & Saya merasa cemas selama melakukan kegiatan ini &  &  &  &  &  &  &  \\ \hline
  5. & Saya merasa tertekan selama melakukan kegiatan ini &  &  &  &  &  &  &  \\ \hline
