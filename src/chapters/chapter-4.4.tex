...
\begin{enumerate}
  ...
  \subitem Adapun pertanyaan nomor 5, 6, dan 8 dari kuesioner SUS yang berhubungan dengan utilitas sebuah sistem digunakan untuk mengukur ketercapaian \textit{usability goal utility}. Pertanyaan lengkap dari kuesioner SUS dapat dilihat pada Lampiran \ref{chpt:testing_hifi}. Jawaban dari setiap partisipan dapat dilihat pada Gambar \ref{img:sus_uti_1}.

  \begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{hifi/hasil-sus-utility.png}
    \caption{Jawaban \textit{System Usability Scale} Pertanyaan Nomor 5, 6, dan 8 untuk Prototipe \textit{High-Fidelity} Iterasi Pertama}
    \label{img:sus_uti_1}
  \end{figure}
  \FloatBarrier

  \subitem Dapat dilihat bahwa 2 orang setuju dan 3 orang sangat setuju bahwa fungsi-fungsi di dalam prototipe dirasa terintegrasi dengan baik, 4 orang sangat tidak setuju namun 1 orang sangat setuju bahwa terdapat banyak hal yang tidak konsisten di dalam prototipe, serta 4 orang sangat tidak setuju bahwa prototipe tidak praktis untuk dipakai. Berdasarkan ketiga pertanyaan kuesioner tersebut, maka dapat dinyatakan bahwa desain solusi masih ada potensi untuk diperbaiki dalam prototipe \textit{high-fidelity} iterasi kedua agar dapat mencapai \textit{usability goal utility} dengan lebih baik. 

  \item \textit{Intrinsic Motivation Inventory} (IMI)
  \subitem  Berdasarkan Gambar \ref{img:imi1_1} dapat dilihat dari metrik IMI untuk subskala \textit{Value/Usefulness}, para partisipan setuju rancangan prototipe \textit{high-fidelity} iterasi pertama sudah mengarah kepada \textit{user experience goal helpful} dengan baik dengan skor terendah sebesar 6,14, tepat di atas ambang batas nilai setuju.
