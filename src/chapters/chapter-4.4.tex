...
\RaggedLeft
\begin{footnotesize}
\begin{longtable}[c]{|>{\ccnormspacingcenter}m{0.14\textwidth}|>{\ccnormspacing}m{0.37\textwidth}|>{\ccnormspacing}m{0.37\textwidth}|}
...
\begin{longtable}[c]{|W{c}{0.12\textwidth}|>{\ccnormspacingcenter}m{0.8\textwidth}|}
  ...
  1 & \cditem{
    \item Partisipan merasa widget Dashboard sebaiknya memuat lebih dari 3 aplikasi teratas
