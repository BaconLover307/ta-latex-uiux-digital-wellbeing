...
\begin{enumerate}
  ...
  \item Penentuan kebutuhan pengguna
  \subitem Tahap ini terdiri dari analisis skenario pengguna, analisis \textit{user experience goals} dan \textit{usability goals}, analisis prinsip desain, serta analisis fitur perangkat lunak. Fitur-fitur yang terkumpul akan menjadi bahan implementasi pada tahap selanjutnya.
