...
\begin{longtable}[c]{|>{\ccnormspacing}m{0.10\textwidth}|>{\ccnormspacing}m{0.31\textwidth}|>{\ccnormspacingcenter}m{0.145\textwidth}|>{\ccnormspacingcenter}m{0.145\textwidth}|>{\ccnormspacingcenter}m{0.145\textwidth}|}
  ...
  \centering P-12 & Ingin mengurangi durasi penggunaan \textit{smartphone} harian & \textbf{V} & \textbf{V} & \textbf{V} \\ \hline
  \centering P-13 & Ingin memantau kebiasaan penggunaan \textit{smartphone} & \textbf{V} & \textbf{V} & \textbf{V} \\ \hline
...
\begin{longtable}[c]{|W{c}{0.07\textwidth}|>{\ccnormspacing}m{\cccolgoal}|>{\ccnormspacing}m{0.38\textwidth}|>{\ccnormspacingcenter}m{\cccolneed}|}
  ...
  UT-05 & \ccgoal{-3}{Mencegah distraksi dari \textit{smartphone} di waktu tertentu} & Memilih aplikasi yang diblokir aksesnya & \ccneed{-3}{P-04, K-01, K-07}\\ \hline
  ...
  UT-08 & \ccgoal{-5}{Membatasi waktu penggunaan \textit{smartphone} harian} & Melihat total waktu penggunaan \textit{smartphone} lewat widget & \ccneed{-5}{P-05, K-02, K-01}\\ \hline
  ...
  UT-11 & \ccgoal{-5}{Menganalisis kebiasaan penggunaan \textit{smartphone}} & Melihat rekomendasi kebiasaan penggunaan \textit{smartphone} yang baik & \ccneed{-5}{P-06, K-03, K-04}\\ \hline
